...
#define V_CC2TOPOFF_THRES		4470  //gemingming@wind-mobi.com 20141008  modfiy the question that the charging voltage can be upto 4.47v #####lets try to check qus1, 4260 def
#define RECHARGING_VOLTAGE      4440  //gemingming@wind-mobi.com 20141008  modfiy the question that the charging voltage can be upto 4.47v #####lets try to check qus1, 4230 def
...
#define USB_CHARGER_CURRENT					CHARGE_CURRENT_650_00_MA	//500mA #####qus1 too many time usb charger; def 550
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1150_00_MA	//gemingming@wind-mobi.com 20140106 begin #####qus1 datasheet 5405 Maximum Charge Rate 1.25a, def 1050

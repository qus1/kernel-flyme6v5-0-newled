...
#define CONFIG_CPU_DVFS_SYSTEM_BOOTUP_BOOST	   1	   /* CPU_DVFS_SYSTEM_BOOTUP_BOOST is used to enhance system bootup time by fixing CPU at max CPU frequency before bootup procedure finished */
#endif
